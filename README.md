...
Time spent: **too many (5-6)** hours spent in total
...
1. Difficulty following lab directions
2. Difficulty with using parse in general

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/ylenuGk.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Parse, forgot to use TableViewDataSource, server issues
